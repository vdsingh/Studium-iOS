...
// TODO: Docstrings
class DEPRECATEDStudiumEventListViewController: SwipeTableViewController, ErrorShowing {
    ...
    lazy var emptyDetailIndicatorViewModel: PositiveCTACardViewModel = {
        PositiveCTACardViewModel(image: nil,
                                 title: "",
                                 subtitle: "",
                                 buttonText: "",
                                 buttonAction: {})
    ...
    private var hostingController: UIHostingController<PositiveCTACardView>?
...
//        self.navigationController?.navigationBar.backgroundColor = StudiumColor.primaryAccent.uiColor
        ...
        self.rightActions = [
            SwipeAction(style: .destructive, title: "Delete") { (_, indexPath) in
                self.delete(at: indexPath)
            }
        ]

        self.leftActions = [
            SwipeAction(style: .default, title: "Edit") { (_, indexPath) in
        ...
        let hostingController = UIHostingController(
            rootView: PositiveCTACardView(viewModel: self.emptyDetailIndicatorViewModel)
        )
...
extension DEPRECATEDStudiumEventListViewController: UISearchResultsUpdating {
